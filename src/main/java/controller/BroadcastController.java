...
public class BroadcastController {
	...
	public ModelAndView category(Integer pageNum, String searchtype, String searchcontent, HttpServletRequest request) {
		...
		int listcount = service.broadcastcount(searchtype, searchcontent, tema); // 전체 등록된 게시물 건수
		List<User> userList = service.broadcastlist(pageNum, limit, searchtype, searchcontent, tema); // 건수만큼 보드 객체를 가져와
