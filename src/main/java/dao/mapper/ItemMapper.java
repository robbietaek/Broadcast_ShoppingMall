...
public interface ItemMapper {
	...
	@Insert("insert into item (itemid, itemname, price, description, pictureUrl1, pictureUrl2, pictureUrl3, pictureUrl4, pictureUrl5, vod, subject, tema) values (#{itemid}, #{itemname}, #{price}, #{description}, #{pictureUrl1}, #{pictureUrl2}, #{pictureUrl3}, #{pictureUrl4}, #{pictureUrl5}, #{vod}, #{subject}, #{tema})")
