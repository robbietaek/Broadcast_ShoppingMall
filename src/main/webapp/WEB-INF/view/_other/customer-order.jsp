          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="customer-orders.shop">My Orders</a></li>
        ...
        <div class="container">
          <div class="row bar">
            <div id="customer-order" class="col-lg-9">
              ...
              <p class="lead text-muted">If you have any questions, please feel free to <a href="contact.shop">contact us</a>, our customer service center is working for you 24/7.</p>
              <div class="box">
