          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="box">
                ...
                <p class="text-muted">If you have any questions, please feel free to <a href="contact.shop">contact us</a>, our customer service center is working for you 24/7.</p>
                <hr>
                <form action="customer-orders.shop" method="get">
