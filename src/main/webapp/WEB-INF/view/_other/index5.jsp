          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row portfolio-showcase">
                ...
                <div class="col-md-6">
                  <h3><a href="portfolio-detail.shop">Portfolio item</a></h3>
                  ...
                  <p class="buttons"><a href="portfolio-detail.shop" class="btn btn-template-outlined">View</a><a href="#" class="btn btn-template-outlined">Visit website</a></p>
                </div>
              </div>
              <div class="heading text-center">
              ...
              <div class="see-more text-center"><a href="portfolio-4.shop" class="btn btn-template-outlined">See more of our work</a></div>
            </div>
          </div>
        </div>
      </section>
