          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="shop-category.shop">Ladies</a></li>
                <li class="breadcrumb-item"><a href="shop-category.shop">Tops</a></li>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="product">
                    ...
                    <div class="text">
                      <h3 class="h5"><a href="shop-detail.shop">Fur coat</a></h3>
                      <p class="price">$143</p>
                    </div>
                  </div>
                </div>
