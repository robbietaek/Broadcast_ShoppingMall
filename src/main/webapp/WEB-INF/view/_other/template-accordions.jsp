              ...
              <div class="panel panel-default sidebar-menu with-icons">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="template-accordions.shop" class="nav-link active">Accordions</a></li>
                    <li class="nav-item"><a href="template-alerts.shop" class="nav-link">Alerts</a></li>
                    <li class="nav-item"><a href="template-buttons.shop" class="nav-link">Buttons</a></li>
                    <li class="nav-item"><a href="template-content-boxes.shop" class="nav-link">Content boxes</a></li>
                    <li class="nav-item"><a href="template-blocks.shop" class="nav-link">Horizontal blocks</a></li>
                    <li class="nav-item"><a href="template-pagination.shop" class="nav-link">Pagination</a></li>
                    <li class="nav-item"><a href="template-tabs.shop" class="nav-link">Tabs</a></li>
                    <li class="nav-item"><a href="template-typography.shop" class="nav-link">Typography</a></li>
                  </ul>
                </div>
              </div>
            </div>
