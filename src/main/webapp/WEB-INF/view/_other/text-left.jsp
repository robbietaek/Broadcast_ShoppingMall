              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="text.shop" class="nav-link">Text page</a></li>
                    <li class="nav-item"><a href="contact.shop" class="nav-link">Contact page</a></li>
                    <li class="nav-item"><a href="faq.shop" class="nav-link">FAQ</a></li>
                  </ul>
                </div>
              </div>
