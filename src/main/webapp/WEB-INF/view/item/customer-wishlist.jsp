						...
						<div class="panel-body">
							<ul class="nav nav-pills flex-column text-sm">
								...
								<li class="nav-item"><a
									...
									class="nav-link active"><i class="fa fa-heart"></i> 찜한 상품</a></li>
								<li class="nav-item"><a
							...
							<c:forEach var="d" items="${dipslist }">
								<div class="col-lg-3 col-md-4">
									<div class="product">
										<div class="image">
											<a
												href="sellingdetail.shop?userid=${d.item.userid }&tema=${d.item.tema}&itemid=${d.item.itemid}"><img
												src="img/${d.item.pictureUrl1 }" alt=""
												class="img-fluid image1"></a>
										</div>
										<div class="text">
											<h3 class="h5">
												<a
													href="sellingdetail.shop?userid=${d.item.userid }&tema=${d.item.tema}&itemid=${d.item.itemid}">${d.item.subject}</a>
											</h3>
