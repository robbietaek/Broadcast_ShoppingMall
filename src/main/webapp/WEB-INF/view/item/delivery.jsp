			...
			<div class="row">
					...
					<div class="panel panel-default sidebar-menu with-icons">
						...
						<div class="panel-body">
							<ul class="nav nav-pills flex-column text-sm">
								...
								<li class="nav-item"><a href=".shop?userid=${sessionScope.loginUser.userid}&year=${sessionScope.loginUser.year}"
				...
				<div id="customer-orders" class="col-md-9">
					<p class="text-muted lead">
						궁금하신 점은 따로  <a
							href="../shop/contact.shop">문의</a>해주시고, 평일 AM 09 - PM 18 연락 가능합니다.
					</p>
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr>
										...
										<td><a href="../item/shop-checkout2.shop"
									...
									<tr>
										...
										<td>22/06/2013</td>
										<td>￦30000</td>
										<td><span class="badge badge-success">배송중</span></td>
										<td><a href="../item/shop-checkout2.shop"
											class="btn btn-template-outlined btn-sm">View</a></td>
									</tr>
									<tr>
										...
										<td>22/06/2013</td>
										<td>￦18000</td>
										<td><span class="badge badge-warning">배송완료</span></td>
										<td><a href="../item/shop-checkout2.shop"
											class="btn btn-template-outlined btn-sm">View</a></td>
									</tr>
								</tbody>
