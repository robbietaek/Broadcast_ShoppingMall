...
<form id="f" method="post" action="return2.shop">
   ...
   <table class="table" style="width:100%">
      <tr><td style="width:40%; text-align: center;">반품이름:</td>
          <td style="width:60%; text-align: center;">${param.itemname }</td>
      </tr>
      <tr><td style="width:40%; text-align: center;">반품사유:</td>
          <td style="width:60%;"><textarea name="text" style="outline-color:#4fbfa8;" cols="30" rows="14" ></textarea></td>
      </tr>
      <tr><td><input class="btn btn-template-outlined btn-sm" style="width:100%; margin: auto;" type="button" onclick="cancle()" value="취소"/></td>
          <td><input class="btn btn-template-outlined btn-sm" style="width:100%; margin: auto;" type="submit" value="반품"/></td>
      </tr>
   </table>
</form>
