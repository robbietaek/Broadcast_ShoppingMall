					...
					<div class="panel panel-default sidebar-menu with-icons">
						...
						<div class="panel-body">
							<ul class="nav nav-pills flex-column text-sm">
								<li class="nav-item"><a href="seller.shop" class="nav-link">판매
										등록</a></li>
								<li class="nav-item"><a href="selled.shop" class="nav-link">판매
										등록 물품 관리</a></li>
								...
								<li class="nav-item"><a href=".shop" class="nav-link">판매
										통계</a></li>
								<li class="nav-item"><a href="qna.shop" class="nav-link">Q&A
										관리</a></li>
								<li class="nav-item"><a href=".shop" class="nav-link">판매된
										목록</a></li>
								<li class="nav-item"><a href=".shop" class="nav-link">반품/취소된
										목록</a></li>
							</ul>
						</div>
					</div>
