            ...
            <div class="row services text-center">
                ...
                <div class="box-simple">
                  <div class="icon-outlined">
                  	<i class="fa fa-desktop" 
                  		onclick = "location.href = '../sellerpage/seller.shop'"></i>
                  </div>
                  <h3 class="h4">
                  	<a href = "../sellerpage/seller.shop">판매자 페이지</a></h3>
              ...
              <div class="col-md-6">
                <div class="box-simple">
                  <div class="icon-outlined">
                  	<i class="fa fa-globe" 
                  		onclick = "location.href = '../buyerpage/customer-order.shop'"></i>
                  </div>
                  <h3 class="h4">
                  	<a href = "../buyerpage/customer-order.shop">구매자 페이지</a></h3>
