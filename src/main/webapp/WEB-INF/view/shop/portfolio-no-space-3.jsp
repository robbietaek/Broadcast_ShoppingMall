                    ...
                    <div class="overlay d-flex align-items-center justify-content-center">
                      <div class="content">
                        ...
                        <div class="text">
                          ...
                          <p class="buttons"><a href="portfolio-detail.shop" class="btn btn-template-outlined-white">View</a><a href="#" class="btn btn-template-outlined-white">Website</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <section class="bar bg-gray">
          <div class="container">
            ...
            <ul class="list-unstyled owl-carousel customers no-mb">
              <li class="item"><img src="../shop/img/customer-1.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="../shop/img/customer-2.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="../shop/img/customer-3.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="../shop/img/customer-4.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="../shop/img/customer-5.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="../shop/img/customer-6.png" alt="" class="img-fluid"></li>
            </ul>
          </div>
        </section>
      </div>
