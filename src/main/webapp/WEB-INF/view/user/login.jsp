                  ...
                  <form:form modelAttribute="user" method="post"
                     ...
                     <p class="text-center">
                        ...
                        <script type="text/javascript">
                           ...
                           var naver_id_login = new naver_id_login("1pOeSW7I1etXR4tam8X7", "http://localhost:8080/project/user/logininfo4.shop");   // Client ID, CallBack URL 삽입
                                                         // 단 'localhost'가 포함된 CallBack URL
                               var state = naver_id_login.getUniqState();
                              
                               naver_id_login.setButton("white", 20, 47);
                               naver_id_login.setDomain("http://localhost:8080/project/user/login4.shop");   //  URL
